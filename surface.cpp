...
void Surface::Centre( char* a_String, int y1, Pixel color )
{
	...
	Print( a_String, x, y1, color, 5);
}
// credits to Boyko for the modifyable font-size version of the Print function!
// https://discord.com/channels/515453022097244160/686661689894240277/943970778246967367 @ https://discord.gg/gsxxaxc (3Dgep.com server)
	...
	for (int y{ 0 }; y < height; y++)
	{
		for (int x{ 0 }; x < width; x++)
		{
			...
			if (color & 0xffffff)
			{
				...
				destination[abs(flip_offset - x)] = color;
			}
		}
